...
classdef MPC_SOLVERBuildable < coder.ExternalDependency
    ...
    methods (Static)
        ...
        function [output,exitflag,info] = forcesCallWithParams(params)
            [output,exitflag,info] = MPC_SOLVERBuildable.forcesCall(params.xinit, params.x0, params.all_parameters, params.num_of_threads);
        end

        function [output,exitflag,info] = forcesCall(xinit, x0, all_parameters, num_of_threads)
