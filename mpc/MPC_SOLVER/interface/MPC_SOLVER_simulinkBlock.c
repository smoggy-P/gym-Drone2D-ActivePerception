...
#define S_FUNCTION_NAME MPC_SOLVER_simulinkBlock
...
static void mdlInitializeSizes(SimStruct *S)
{
	...
	/* Input Port 2 */
    ssSetInputPortMatrixDimensions(S,  2, 700, 1);
